use xlab::OneOrMany;
use xlab::embeddings::{Embedding, EmbeddingModel};
use xlab::vector_store::request::VectorSearchRequest;
use xlab::vector_store::{VectorStoreError, VectorStoreIndex};
...
/// use xlab::Embed;
/// use serde::Deserialize;
/// use xlab_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for xlab.
///
/// This crate provides a SQLite-based vector store implementation that can be used with xlab.
...
///     Embed,
/// };
/// use xlab_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]
