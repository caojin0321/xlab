...
This companion crate implements a xlab vector store based on PostgreSQL.
...
You can also run `cargo add xlab-core xlab-postgres` to add the most recent versions of the dependencies to your project.
