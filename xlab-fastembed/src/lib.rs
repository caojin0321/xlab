...
/// The `xlab-fastembed` client.
///
/// Use this as your main entrypoint for any `xlab-fastembed` functionality.
#[derive(Clone)]
pub struct Client;
...
impl Client {
    /// Create a new `xlab-fastembed` client.
    pub fn new() -> Self {
        Self
    }
    ...
    /// # Example
    /// ```
    /// use xlab_fastembed::{Client, FastembedModel};
    ///
    /// // Initialize the `xlab-fastembed` client
    /// let fastembed_client = xlab_fastembed::Client::new();
    ///
