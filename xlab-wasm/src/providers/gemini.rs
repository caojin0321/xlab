...
use xlab::client::{CompletionClient, EmbeddingsClient, TranscriptionClient};
use xlab::completion::{Chat, CompletionModel, Prompt};
use xlab::embeddings::EmbeddingModel;
use xlab::providers::gemini::completion::gemini_api_types::GenerateContentResponse;
...
#[wasm_bindgen]
pub struct GeminiAgent(Agent<xlab::providers::gemini::completion::CompletionModel>);
...
impl GeminiAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::gemini::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct GeminiCompletionModel(xlab::providers::gemini::completion::CompletionModel);
...
impl GeminiCompletionModel {
    ...
    pub fn new(opts: JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::gemini::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct GeminiEmbeddingModel(xlab::providers::gemini::embedding::EmbeddingModel);
...
#[wasm_bindgen]
pub struct GeminiTranscriptionModel(xlab::providers::gemini::transcription::TranscriptionModel);
