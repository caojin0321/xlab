...
#[wasm_bindgen]
pub struct HyperbolicAgent(xlab::agent::Agent<xlab::providers::hyperbolic::CompletionModel>);
...
impl HyperbolicAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::hyperbolic::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct HyperbolicCompletionsModel(xlab::providers::hyperbolic::CompletionModel);
...
impl HyperbolicCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::hyperbolic::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct HyperbolicImageGenerationModel(xlab::providers::hyperbolic::ImageGenerationModel);
...
pub struct HyperbolicImageGenerationResponse(
    xlab::image_generation::ImageGenerationResponse<
        xlab::providers::hyperbolic::ImageGenerationResponse,
    >,
);
...
#[wasm_bindgen]
pub struct HyperbolicAudioGenerationModel(xlab::providers::hyperbolic::AudioGenerationModel);
