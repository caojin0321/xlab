...
#[wasm_bindgen]
pub struct OllamaAgent(xlab::agent::Agent<xlab::providers::ollama::CompletionModel>);
...
impl OllamaAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::ollama::Client::new().agent(&model);
...
#[wasm_bindgen]
pub struct OllamaCompletionsModel(xlab::providers::ollama::CompletionModel);
...
impl OllamaCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::ollama::Client::new();
