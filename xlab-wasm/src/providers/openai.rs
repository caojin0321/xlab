...
use xlab::agent::Agent;
use xlab::audio_generation::{AudioGenerationModel, AudioGenerationResponse};
use xlab::client::embeddings::EmbeddingsClient;
use xlab::client::image_generation::ImageGenerationClient;
use xlab::client::{AudioGenerationClient, CompletionClient, TranscriptionClient};
...
use xlab::transcription::{TranscriptionModelDyn, TranscriptionResponse};
use wasm_bindgen::prelude::*;
use wasm_bindgen_futures::js_sys::{self, Array, Reflect, Uint8Array};
use wasm_streams::ReadableStream;

#[wasm_bindgen]
pub struct OpenAIAgent(Agent<xlab::providers::openai::responses_api::ResponsesCompletionModel>);
...
impl OpenAIAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::openai::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct OpenAICompletionsCompletionModel(xlab::providers::openai::completion::CompletionModel);
...
#[wasm_bindgen]
pub struct OpenAIEmbeddingModel(xlab::providers::openai::embedding::EmbeddingModel);
...
#[wasm_bindgen]
pub struct OpenAITranscriptionModel(xlab::providers::openai::TranscriptionModel);
...
#[wasm_bindgen]
pub struct OpenAIImageGenerationModel(xlab::providers::openai::ImageGenerationModel);
...
pub struct OpenAIImageGenerationResponse(
    xlab::image_generation::ImageGenerationResponse<xlab::providers::openai::ImageGenerationResponse>,
);
