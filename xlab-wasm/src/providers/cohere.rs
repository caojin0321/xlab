...
use xlab::client::completion::CompletionClient;
use xlab::completion::CompletionModel;
use xlab::completion::{Chat, Prompt};
...
#[wasm_bindgen]
pub struct CohereAgent(xlab::agent::Agent<xlab::providers::cohere::CompletionModel>);
...
impl CohereAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::cohere::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct CohereCompletionModel(xlab::providers::cohere::CompletionModel);
...
impl CohereCompletionModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::cohere::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct CohereEmbeddingModel(xlab::providers::cohere::EmbeddingModel);
