...
#[wasm_bindgen]
pub struct MiraAgent(xlab::agent::Agent<xlab::providers::mira::CompletionModel>);
...
impl MiraAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::mira::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct MiraCompletionsModel(xlab::providers::mira::CompletionModel);
...
impl MiraCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let model = xlab::providers::mira::Client::new(&model_opts.api_key)
