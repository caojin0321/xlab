...
#[wasm_bindgen]
pub struct MistralAgent(Agent<xlab::providers::mistral::CompletionModel>);
...
impl MistralAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::mistral::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct MistralCompletionsModel(xlab::providers::mistral::CompletionModel);
...
impl MistralCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::mistral::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct MistralEmbeddingModel(xlab::providers::mistral::embedding::EmbeddingModel);
