use crate::{JsModelOpts, JsResult, JsTranscriptionOpts, ModelOpts};
...
use xlab::client::{CompletionClient, TranscriptionClient};
use xlab::completion::{Chat, CompletionModel, Prompt};
use xlab::streaming::StreamingPrompt;
use wasm_streams::ReadableStream;

#[wasm_bindgen]
pub struct HuggingFaceAgent(
    xlab::agent::Agent<xlab::providers::huggingface::completion::CompletionModel>,
);

#[wasm_bindgen]
impl HuggingFaceAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::huggingface::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct HuggingFaceCompletionsModel(xlab::providers::huggingface::completion::CompletionModel);
...
impl HuggingFaceCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::huggingface::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct HuggingFaceImageGenerationModel(
    xlab::providers::huggingface::image_generation::ImageGenerationModel,
);

#[wasm_bindgen]
impl HuggingFaceImageGenerationModel {
    #[wasm_bindgen(constructor)]
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        let model_opts: ModelOpts = serde_wasm_bindgen::from_value(opts.obj)
            .map_err(|x| JsError::new(format!("Failed to create model options: {x}").as_ref()))?;
    ...
    pub async fn image_generation(
    ...
    ) -> JsResult<HuggingFaceImageGenerationResponse> {
        let req =
        ...
        Ok(HuggingFaceImageGenerationResponse(res))
    }
}

#[wasm_bindgen]
pub struct HuggingFaceImageGenerationResponse(
    xlab::image_generation::ImageGenerationResponse<
        xlab::providers::huggingface::image_generation::ImageGenerationResponse,
    >,
);

#[wasm_bindgen]
impl HuggingFaceImageGenerationResponse {
...
pub struct HuggingFaceTranscriptionModel(
    xlab::providers::huggingface::transcription::TranscriptionModel,
);
...
impl HuggingFaceTranscriptionModel {
    ...
    pub async fn transcription(
    ...
    ) -> JsResult<HuggingFaceTranscriptionResponse> {
        let req =
        ...
        let transcription = HuggingFaceTranscriptionResponse(res);
...
#[wasm_bindgen]
pub struct HuggingFaceTranscriptionResponse(
    TranscriptionResponse<xlab::providers::huggingface::transcription::TranscriptionResponse>,
);

#[wasm_bindgen]
impl HuggingFaceTranscriptionResponse {
    #[wasm_bindgen(getter)]
