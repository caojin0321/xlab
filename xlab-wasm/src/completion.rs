...
use xlab::{OneOrMany, message::ToolCall};
...
#[wasm_bindgen]
#[derive(Clone)]
pub struct Message(xlab::message::Message);

impl From<Message> for xlab::message::Message {
    fn from(value: Message) -> Self {
        value.0
    }
}

impl From<xlab::message::Message> for Message {
    fn from(value: xlab::message::Message) -> Self {
        Self(value)
    }
}
...
#[wasm_bindgen]
#[derive(Clone)]
pub struct Document(xlab::completion::Document);

impl From<Document> for xlab::completion::Document {
    fn from(value: Document) -> Self {
        value.0
    }
}

impl From<xlab::completion::Document> for Document {
    fn from(value: xlab::completion::Document) -> Self {
        Self(value)
    }
}
...
#[wasm_bindgen]
#[derive(Clone)]
pub struct ToolDefinition(xlab::completion::ToolDefinition);

impl From<ToolDefinition> for xlab::completion::ToolDefinition {
    fn from(value: ToolDefinition) -> Self {
        value.0
    }
}

impl From<xlab::completion::ToolDefinition> for ToolDefinition {
    fn from(value: xlab::completion::ToolDefinition) -> Self {
        Self(value)
    }
}
...
impl ToolDefinition {
    ...
    pub fn new(args: JsValue) -> JsResult<Self> {
        let args: xlab::completion::ToolDefinition =
...
#[wasm_bindgen]
#[allow(dead_code)]
pub struct AssistantContent(xlab::completion::AssistantContent);

impl From<AssistantContent> for xlab::completion::AssistantContent {
...
impl AssistantContent {
    pub fn text(text: &str) -> Self {
        Self(xlab::completion::AssistantContent::Text(
            xlab::message::Text {
                text: text.to_string(),
            },
        ))
    ...
    pub fn tool_call(id: &str, function: ToolFunction) -> Self {
        Self(xlab::completion::AssistantContent::ToolCall(ToolCall {
            id: id.to_string(),
            call_id: None,
            function: function.0,
        }))
...
#[wasm_bindgen]
pub struct ToolFunction(xlab::completion::message::ToolFunction);

impl From<ToolFunction> for xlab::completion::message::ToolFunction {
...
impl From<xlab::completion::AssistantContent> for AssistantContent {
    fn from(value: xlab::completion::AssistantContent) -> Self {
        Self(value)
    }
}
...
impl From<CompletionRequest> for xlab::completion::CompletionRequest {
    fn from(value: CompletionRequest) -> Self {
        ...
        Self {
            ...
            documents: documents
                .into_iter()
                .map(xlab::completion::Document::from)
                .collect(),
            tools: tools
                .into_iter()
                .map(xlab::completion::ToolDefinition::from)
                .collect(),
            temperature,
            max_tokens,
            additional_params,
...
pub fn convert_messages_from_jsvalue(value: JsValue) -> JsResult<Vec<Message>> {
    let val: Vec<Message> = serde_wasm_bindgen::from_value::<Vec<xlab::message::Message>>(value)
        .map_err(|x| {
            JsError::new(
...
pub fn convert_tooldefs_from_jsvalue(value: JsValue) -> JsResult<Vec<ToolDefinition>> {
    let val: Vec<ToolDefinition> = serde_wasm_bindgen::from_value::<
        Vec<xlab::completion::ToolDefinition>,
    >(value)
    .map_err(|x| {
        JsError::new(
...
pub fn convert_documents_from_jsvalue(value: JsValue) -> JsResult<Vec<Document>> {
    let val: Vec<Document> =
        serde_wasm_bindgen::from_value::<Vec<xlab::completion::Document>>(value)
            .map_err(|x| {
                JsError::new(
...
pub struct CompletionResponse<T> {
    choice: OneOrMany<xlab::completion::AssistantContent>,
    raw_response: T,
}

impl<T> From<xlab::completion::CompletionResponse<T>> for CompletionResponse<T>
where
    T: serde::Serialize,
{
    fn from(value: xlab::completion::CompletionResponse<T>) -> Self {
        Self {
            choice: value.choice,
