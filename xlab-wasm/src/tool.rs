...
impl xlab::tool::Tool for JsTool {
    type Args = serde_json::Value;
    type Error = xlab::tool::ToolError;
    ...
    fn definition(
        &self,
        prompt: String,
    ) -> impl Future<Output = xlab::completion::ToolDefinition> + Send + Sync {
        ...
        let value: xlab::completion::ToolDefinition = serde_wasm_bindgen::from_value(res)
