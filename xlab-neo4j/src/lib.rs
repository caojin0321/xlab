//! A xlab vector store for Neo4j.
//!
//! This crate is a companion crate to the [xlab-core crate](https://github.com/caojin0321/xlab).
//! It provides a vector store implementation that uses Neo4j as the underlying datastore.
//!
//! See the [README](https://github.com/caojin0321/xlab/tree/main/xlab-neo4j) for more information.
//!
//! ## Prerequisites
//!
//! ### GenAI Plugin
...
//!
//! ## Simple example:
//! More examples can be found in the [/examples](https://github.com/caojin0321/xlab/tree/main/xlab-neo4j/examples) folder.
//! ```
//! use xlab_neo4j::{vector_index::*, Neo4jClient};
//! use neo4rs::ConfigBuilder;
//! use xlab::{providers::openai::*, vector_store::VectorStoreIndex};
...
use neo4rs::*;
use xlab::{embeddings::EmbeddingModel, vector_store::VectorStoreError};
use serde::Deserialize;
...
fn neo4j_to_xlab_error(e: neo4rs::Error) -> VectorStoreError {
