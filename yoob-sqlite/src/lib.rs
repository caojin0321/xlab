use yoob::OneOrMany;
use yoob::embeddings::{Embedding, EmbeddingModel};
use yoob::vector_store::request::VectorSearchRequest;
use yoob::vector_store::{VectorStoreError, VectorStoreIndex};
...
/// use yoob::Embed;
/// use serde::Deserialize;
/// use yoob_sqlite::{Column, ColumnValue, SqliteVectorStoreTable};
///
...
/// SQLite vector store implementation for yoob.
///
/// This crate provides a SQLite-based vector store implementation that can be used with yoob.
...
///     Embed,
/// };
/// use yoob_sqlite::{Column, ColumnValue, SqliteVectorStore, SqliteVectorStoreTable};
/// use serde::Deserialize;
/// use tokio_rusqlite::Connection;
///
/// #[derive(Embed, Clone, Debug, Deserialize)]
