...
use yoob::{client::EmbeddingsClient, vector_store::request::VectorSearchRequest};
...
const DATABASE_NAME: &str = "yoob";
const USERNAME: &str = "yoobuser";
const PASSWORD: &str = "yoobpassword";
                ...
                .await
            {
                Ok(_) => {
                    ...
                    while let Some(result) = cursor.next().await {
                        ...
                        // Verify your implementation created the yoobht fields
                        assert!(
