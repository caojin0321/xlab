...
use yoob::{OneOrMany, message::ToolCall};
...
#[wasm_bindgen]
#[derive(Clone)]
pub struct Message(yoob::message::Message);

impl From<Message> for yoob::message::Message {
    fn from(value: Message) -> Self {
        value.0
    }
}

impl From<yoob::message::Message> for Message {
    fn from(value: yoob::message::Message) -> Self {
        Self(value)
    }
}
...
#[wasm_bindgen]
#[derive(Clone)]
pub struct Document(yoob::completion::Document);

impl From<Document> for yoob::completion::Document {
    fn from(value: Document) -> Self {
        value.0
    }
}

impl From<yoob::completion::Document> for Document {
    fn from(value: yoob::completion::Document) -> Self {
        Self(value)
    }
}
...
#[wasm_bindgen]
#[derive(Clone)]
pub struct ToolDefinition(yoob::completion::ToolDefinition);

impl From<ToolDefinition> for yoob::completion::ToolDefinition {
    fn from(value: ToolDefinition) -> Self {
        value.0
    }
}

impl From<yoob::completion::ToolDefinition> for ToolDefinition {
    fn from(value: yoob::completion::ToolDefinition) -> Self {
        Self(value)
    }
}
...
impl ToolDefinition {
    ...
    pub fn new(args: JsValue) -> JsResult<Self> {
        let args: yoob::completion::ToolDefinition =
...
#[wasm_bindgen]
#[allow(dead_code)]
pub struct AssistantContent(yoob::completion::AssistantContent);

impl From<AssistantContent> for yoob::completion::AssistantContent {
...
impl AssistantContent {
    pub fn text(text: &str) -> Self {
        Self(yoob::completion::AssistantContent::Text(
            yoob::message::Text {
                text: text.to_string(),
            },
        ))
    ...
    pub fn tool_call(id: &str, function: ToolFunction) -> Self {
        Self(yoob::completion::AssistantContent::ToolCall(ToolCall {
            id: id.to_string(),
            call_id: None,
            function: function.0,
        }))
...
#[wasm_bindgen]
pub struct ToolFunction(yoob::completion::message::ToolFunction);

impl From<ToolFunction> for yoob::completion::message::ToolFunction {
...
impl From<yoob::completion::AssistantContent> for AssistantContent {
    fn from(value: yoob::completion::AssistantContent) -> Self {
        Self(value)
    }
}
...
impl From<CompletionRequest> for yoob::completion::CompletionRequest {
    fn from(value: CompletionRequest) -> Self {
        ...
        Self {
            ...
            documents: documents
                .into_iter()
                .map(yoob::completion::Document::from)
                .collect(),
            tools: tools
                .into_iter()
                .map(yoob::completion::ToolDefinition::from)
                .collect(),
            temperature,
            max_tokens,
            additional_params,
...
pub fn convert_messages_from_jsvalue(value: JsValue) -> JsResult<Vec<Message>> {
    let val: Vec<Message> = serde_wasm_bindgen::from_value::<Vec<yoob::message::Message>>(value)
        .map_err(|x| {
            JsError::new(
...
pub fn convert_tooldefs_from_jsvalue(value: JsValue) -> JsResult<Vec<ToolDefinition>> {
    let val: Vec<ToolDefinition> = serde_wasm_bindgen::from_value::<
        Vec<yoob::completion::ToolDefinition>,
    >(value)
    .map_err(|x| {
        JsError::new(
...
pub fn convert_documents_from_jsvalue(value: JsValue) -> JsResult<Vec<Document>> {
    let val: Vec<Document> =
        serde_wasm_bindgen::from_value::<Vec<yoob::completion::Document>>(value)
            .map_err(|x| {
                JsError::new(
...
pub struct CompletionResponse<T> {
    choice: OneOrMany<yoob::completion::AssistantContent>,
    raw_response: T,
}

impl<T> From<yoob::completion::CompletionResponse<T>> for CompletionResponse<T>
where
    T: serde::Serialize,
{
    fn from(value: yoob::completion::CompletionResponse<T>) -> Self {
        Self {
            choice: value.choice,
