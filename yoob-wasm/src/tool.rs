...
impl yoob::tool::Tool for JsTool {
    type Args = serde_json::Value;
    type Error = yoob::tool::ToolError;
    ...
    fn definition(
        &self,
        prompt: String,
    ) -> impl Future<Output = yoob::completion::ToolDefinition> + Send + Sync {
        ...
        let value: yoob::completion::ToolDefinition = serde_wasm_bindgen::from_value(res)
