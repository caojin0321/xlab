...
#[wasm_bindgen]
pub struct OllamaAgent(yoob::agent::Agent<yoob::providers::ollama::CompletionModel>);
...
impl OllamaAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::ollama::Client::new().agent(&model);
...
#[wasm_bindgen]
pub struct OllamaCompletionsModel(yoob::providers::ollama::CompletionModel);
...
impl OllamaCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::ollama::Client::new();
