...
#[wasm_bindgen]
pub struct DeepSeekAgent(xlab::agent::Agent<xlab::providers::deepseek::CompletionModel>);
...
impl DeepSeekAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::deepseek::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct DeepSeekCompletionsModel(xlab::providers::deepseek::CompletionModel);
...
impl DeepSeekCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::deepseek::Client::new(&model_opts.api_key);
