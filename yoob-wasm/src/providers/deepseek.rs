...
#[wasm_bindgen]
pub struct DeepSeekAgent(yoob::agent::Agent<yoob::providers::deepseek::CompletionModel>);
...
impl DeepSeekAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::deepseek::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct DeepSeekCompletionsModel(yoob::providers::deepseek::CompletionModel);
...
impl DeepSeekCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::deepseek::Client::new(&model_opts.api_key);
