...
use yoob::agent::Agent;
use yoob::audio_generation::{AudioGenerationModel, AudioGenerationResponse};
use yoob::client::embeddings::EmbeddingsClient;
use yoob::client::image_generation::ImageGenerationClient;
use yoob::client::{AudioGenerationClient, CompletionClient, TranscriptionClient};
...
use yoob::transcription::{TranscriptionModelDyn, TranscriptionResponse};
use wasm_bindgen::prelude::*;
use wasm_bindgen_futures::js_sys::{self, Array, Reflect, Uint8Array};
use wasm_streams::ReadableStream;

#[wasm_bindgen]
pub struct OpenAIAgent(Agent<yoob::providers::openai::responses_api::ResponsesCompletionModel>);
...
impl OpenAIAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::openai::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct OpenAICompletionsCompletionModel(yoob::providers::openai::completion::CompletionModel);
...
#[wasm_bindgen]
pub struct OpenAIEmbeddingModel(yoob::providers::openai::embedding::EmbeddingModel);
...
#[wasm_bindgen]
pub struct OpenAITranscriptionModel(yoob::providers::openai::TranscriptionModel);
...
#[wasm_bindgen]
pub struct OpenAIImageGenerationModel(yoob::providers::openai::ImageGenerationModel);
...
pub struct OpenAIImageGenerationResponse(
    yoob::image_generation::ImageGenerationResponse<yoob::providers::openai::ImageGenerationResponse>,
);
