...
#[wasm_bindgen]
pub struct HyperbolicAgent(yoob::agent::Agent<yoob::providers::hyperbolic::CompletionModel>);
...
impl HyperbolicAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::hyperbolic::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct HyperbolicCompletionsModel(yoob::providers::hyperbolic::CompletionModel);
...
impl HyperbolicCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::hyperbolic::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct HyperbolicImageGenerationModel(yoob::providers::hyperbolic::ImageGenerationModel);
...
pub struct HyperbolicImageGenerationResponse(
    yoob::image_generation::ImageGenerationResponse<
        yoob::providers::hyperbolic::ImageGenerationResponse,
    >,
);
...
#[wasm_bindgen]
pub struct HyperbolicAudioGenerationModel(yoob::providers::hyperbolic::AudioGenerationModel);
