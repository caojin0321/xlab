...
pub struct AnthropicAgent(
    yoob::agent::Agent<yoob::providers::anthropic::completion::CompletionModel>,
);
...
impl AnthropicAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::anthropic::ClientBuilder::new(&api_key)
            .build()
...
#[wasm_bindgen]
pub struct AnthropicCompletionModel(yoob::providers::anthropic::completion::CompletionModel);
...
impl AnthropicCompletionModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::anthropic::ClientBuilder::new(&model_opts.api_key)
            .build()
            .map_err(|x| JsError::new(x.to_string().as_ref()))?;
