...
#[wasm_bindgen]
pub struct MistralAgent(Agent<yoob::providers::mistral::CompletionModel>);
...
impl MistralAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::mistral::Client::new(&api_key).agent(&model);
...
/// The Mistral completions chat API.
#[wasm_bindgen]
pub struct MistralCompletionsModel(yoob::providers::mistral::CompletionModel);

#[wasm_bindgen]
impl MistralCompletionsModel {
    #[wasm_bindgen(constructor)]
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::mistral::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct MistralEmbeddingModel(yoob::providers::mistral::embedding::EmbeddingModel);
