...
#[wasm_bindgen]
pub struct PerplexityAgent(yoob::agent::Agent<yoob::providers::perplexity::CompletionModel>);
...
impl PerplexityAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::perplexity::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct PerplexityCompletionsModel(yoob::providers::perplexity::CompletionModel);
...
impl PerplexityCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::perplexity::Client::new(&model_opts.api_key);
