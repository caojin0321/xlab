...
#[wasm_bindgen]
pub struct PerplexityAgent(xlab::agent::Agent<xlab::providers::perplexity::CompletionModel>);
...
impl PerplexityAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::perplexity::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct PerplexityCompletionsModel(xlab::providers::perplexity::CompletionModel);
...
impl PerplexityCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::perplexity::Client::new(&model_opts.api_key);
