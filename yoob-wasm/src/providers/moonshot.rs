...
#[wasm_bindgen]
pub struct MoonshotAgent(xlab::agent::Agent<xlab::providers::moonshot::CompletionModel>);
...
impl MoonshotAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::moonshot::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct MoonshotCompletionsModel(xlab::providers::moonshot::CompletionModel);
...
impl MoonshotCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::moonshot::Client::new(&model_opts.api_key);
