...
#[wasm_bindgen]
pub struct MoonshotAgent(yoob::agent::Agent<yoob::providers::moonshot::CompletionModel>);
...
impl MoonshotAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::moonshot::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct MoonshotCompletionsModel(yoob::providers::moonshot::CompletionModel);
...
impl MoonshotCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::moonshot::Client::new(&model_opts.api_key);
