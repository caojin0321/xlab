...
#[wasm_bindgen]
pub struct TogetherAgent(Agent<yoob::providers::together::completion::CompletionModel>);
...
impl TogetherAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::together::Client::new(&api_key).agent(&model);
...
/// The TogetherAI completions chat API.
#[wasm_bindgen]
pub struct TogetherCompletionsModel(yoob::providers::together::completion::CompletionModel);

#[wasm_bindgen]
impl TogetherCompletionsModel {
    #[wasm_bindgen(constructor)]
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::together::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct TogetherEmbeddingModel(yoob::providers::together::embedding::EmbeddingModel);

#[wasm_bindgen]
impl TogetherEmbeddingModel {
    #[wasm_bindgen(constructor)]
