...
#[wasm_bindgen]
pub struct TogetherAgent(Agent<xlab::providers::together::completion::CompletionModel>);
...
impl TogetherAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::together::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct TogetherCompletionsModel(xlab::providers::together::completion::CompletionModel);
...
impl TogetherCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::together::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct TogetherEmbeddingModel(xlab::providers::together::embedding::EmbeddingModel);
