...
use yoob::client::completion::CompletionClient;
use yoob::completion::CompletionModel;
use yoob::completion::{Chat, Prompt};
...
#[wasm_bindgen]
pub struct CohereAgent(yoob::agent::Agent<yoob::providers::cohere::CompletionModel>);
...
impl CohereAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::cohere::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct CohereCompletionModel(yoob::providers::cohere::CompletionModel);
...
impl CohereCompletionModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::cohere::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct CohereEmbeddingModel(yoob::providers::cohere::EmbeddingModel);
