...
#[wasm_bindgen]
pub struct XaiAgent(Agent<xlab::providers::xai::completion::CompletionModel>);
...
impl XaiAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::xai::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct XaiCompletionsModel(xlab::providers::xai::completion::CompletionModel);
...
impl XaiCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::xai::Client::new(&model_opts.api_key);
