...
use crate::{JsAgentOpts, JsResult, ModelOpts};
...
#[wasm_bindgen]
pub struct XaiAgent(Agent<yoob::providers::xai::completion::CompletionModel>);
...
impl XaiAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::xai::Client::new(&api_key).agent(&model);
...
/// The xAI completions chat API.
#[wasm_bindgen]
pub struct XaiCompletionsModel(yoob::providers::xai::completion::CompletionModel);

#[wasm_bindgen]
impl XaiCompletionsModel {
    #[wasm_bindgen(constructor)]
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::xai::Client::new(&model_opts.api_key);
