...
#[wasm_bindgen]
pub struct MiraAgent(yoob::agent::Agent<yoob::providers::mira::CompletionModel>);
...
impl MiraAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::mira::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct MiraCompletionsModel(yoob::providers::mira::CompletionModel);
...
impl MiraCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let model = yoob::providers::mira::Client::new(&model_opts.api_key)
