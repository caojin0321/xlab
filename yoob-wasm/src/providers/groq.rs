...
#[wasm_bindgen]
pub struct GroqAgent(yoob::agent::Agent<yoob::providers::groq::CompletionModel>);
...
impl GroqAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::groq::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct GroqCompletionsCompletionModel(yoob::providers::groq::CompletionModel);

#[wasm_bindgen]
impl GroqCompletionsCompletionModel {
    #[wasm_bindgen(constructor)]
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::groq::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct GroqTranscriptionModel(yoob::providers::groq::TranscriptionModel);
...
impl GroqTranscriptionModel {
    ...
    pub async fn transcription(
    ...
    ) -> JsResult<GroqTranscriptionResponse> {
        let req =
        ...
        let transcription = GroqTranscriptionResponse(res);
...
pub struct GroqTranscriptionResponse(
    TranscriptionResponse<yoob::providers::openai::transcription::TranscriptionResponse>,
);

#[wasm_bindgen]
impl GroqTranscriptionResponse {
    #[wasm_bindgen(getter)]
