...
#[wasm_bindgen]
pub struct GroqAgent(xlab::agent::Agent<xlab::providers::groq::CompletionModel>);
...
impl GroqAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = xlab::providers::groq::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct GroqCompletionsCompletionModel(xlab::providers::groq::CompletionModel);
...
impl GroqCompletionsCompletionModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = xlab::providers::groq::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct GroqTranscriptionModel(xlab::providers::groq::TranscriptionModel);
...
pub struct GroqTranscriptionResponse(
    TranscriptionResponse<xlab::providers::openai::transcription::TranscriptionResponse>,
);
