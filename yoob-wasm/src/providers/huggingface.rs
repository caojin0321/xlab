...
use yoob::client::{CompletionClient, TranscriptionClient};
...
pub struct HuggingFaceAgent(
    yoob::agent::Agent<yoob::providers::huggingface::completion::CompletionModel>,
);
...
impl HuggingFaceAgent {
    ...
    pub fn new(opts: crate::JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::huggingface::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct HuggingFaceCompletionsModel(yoob::providers::huggingface::completion::CompletionModel);
...
impl HuggingFaceCompletionsModel {
    ...
    pub fn new(opts: crate::JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::huggingface::Client::new(&model_opts.api_key);
...
pub struct HuggingFaceImageGenerationModel(
    yoob::providers::huggingface::image_generation::ImageGenerationModel,
);
...
pub struct HuggingFaceImageGenerationResponse(
    yoob::image_generation::ImageGenerationResponse<
        yoob::providers::huggingface::image_generation::ImageGenerationResponse,
    >,
);
...
pub struct HuggingFaceTranscriptionModel(
    yoob::providers::huggingface::transcription::TranscriptionModel,
);
...
pub struct HuggingFaceTranscriptionResponse(
    TranscriptionResponse<yoob::providers::huggingface::transcription::TranscriptionResponse>,
);
