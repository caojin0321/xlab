...
use yoob::client::{CompletionClient, EmbeddingsClient, TranscriptionClient};
use yoob::completion::{Chat, CompletionModel, Prompt};
use yoob::embeddings::EmbeddingModel;
use yoob::providers::gemini::completion::gemini_api_types::GenerateContentResponse;
...
#[wasm_bindgen]
pub struct GeminiAgent(Agent<yoob::providers::gemini::completion::CompletionModel>);
...
impl GeminiAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::gemini::Client::new(&api_key).agent(&model);
...
#[wasm_bindgen]
pub struct GeminiCompletionModel(yoob::providers::gemini::completion::CompletionModel);
...
impl GeminiCompletionModel {
    ...
    pub fn new(opts: JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::gemini::Client::new(&model_opts.api_key);
...
#[wasm_bindgen]
pub struct GeminiEmbeddingModel(yoob::providers::gemini::embedding::EmbeddingModel);
...
#[wasm_bindgen]
pub struct GeminiTranscriptionModel(yoob::providers::gemini::transcription::TranscriptionModel);
