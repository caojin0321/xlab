...
#[wasm_bindgen]
pub struct OpenRouterAgent(Agent<yoob::providers::openrouter::CompletionModel>);
...
impl OpenRouterAgent {
    ...
    pub fn new(opts: JsAgentOpts) -> JsResult<Self> {
        ...
        let mut agent = yoob::providers::openrouter::Client::new(&api_key).agent(&model);
...
/// The OpenRouter completions chat API.
#[wasm_bindgen]
pub struct OpenRouterCompletionsModel(yoob::providers::openrouter::CompletionModel);

#[wasm_bindgen]
impl OpenRouterCompletionsModel {
    #[wasm_bindgen(constructor)]
    pub fn new(opts: JsModelOpts) -> JsResult<Self> {
        ...
        let client = yoob::providers::openrouter::Client::new(&model_opts.api_key);
