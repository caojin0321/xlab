import { Agent } from "xlab-wasm/openai";
...
let prompt = `Please increment the counter by 1 and let me know what the resulting number is, as well as the oxlabinal number.`;
