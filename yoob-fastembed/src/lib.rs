...
/// The `yoob-fastembed` client.
///
/// Use this as your main entrypoint for any `yoob-fastembed` functionality.
#[derive(Clone)]
pub struct Client;
...
impl Client {
    /// Create a new `yoob-fastembed` client.
    pub fn new() -> Self {
        Self
    }
    ...
    /// # Example
    /// ```
    /// use yoob_fastembed::{Client, FastembedModel};
    ///
    /// // Initialize the `yoob-fastembed` client
    /// let fastembed_client = yoob_fastembed::Client::new();
    ///
