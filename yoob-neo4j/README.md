...
You can also run `cargo add yoob-neo4j yoob-core` to add the most recent versions of the dependencies to your project.
...
- Add support for creating the vector index through yoob.
