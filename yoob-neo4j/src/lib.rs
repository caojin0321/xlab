//! A yoob vector store for Neo4j.
//!
//! This crate is a companion crate to the [yoob-core crate](https://github.com/caojin0321/yoob).
//! It provides a vector store implementation that uses Neo4j as the underlying datastore.
//!
//! See the [README](https://github.com/caojin0321/yoob/tree/main/yoob-neo4j) for more information.
//!
//! ## Prerequisites
//!
//! ### GenAI Plugin
...
//!
//! ## Simple example:
//! More examples can be found in the [/examples](https://github.com/caojin0321/yoob/tree/main/yoob-neo4j/examples) folder.
//! ```
//! use yoob_neo4j::{vector_index::*, Neo4jClient};
//! use neo4rs::ConfigBuilder;
//! use yoob::{providers::openai::*, vector_store::VectorStoreIndex};
...
use neo4rs::*;
use yoob::{embeddings::EmbeddingModel, vector_store::VectorStoreError};
use serde::Deserialize;
...
fn neo4j_to_yoob_error(e: neo4rs::Error) -> VectorStoreError {
