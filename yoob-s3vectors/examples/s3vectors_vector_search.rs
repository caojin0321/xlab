...
use yoob::Embed;
use yoob::client::EmbeddingsClient;
use yoob::embeddings::EmbeddingsBuilder;
use yoob::providers::openai::Client as OpenAIClient;
use yoob::providers::openai::TEXT_EMBEDDING_ADA_002;
use yoob::vector_store::request::VectorSearchRequest;
use yoob::vector_store::{InsertDocuments, VectorStoreIndex};
use std::env;
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let store =
        yoob_s3vectors::S3VectorsVectorStore::new(model, s3vectors_client, BUCKET_NAME, INDEX_NAME);
