...
use xlab::streaming::StreamingCompletionResponse;
use xlab::{completion::CompletionError, streaming::RawStreamingChoice};
...
impl CompletionModel {
    pub(crate) async fn stream(
        &self,
        completion_request: xlab::completion::CompletionRequest,
