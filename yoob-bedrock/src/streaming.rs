...
use yoob::streaming::StreamingCompletionResponse;
use yoob::{completion::CompletionError, streaming::RawStreamingChoice};
...
impl CompletionModel {
    pub(crate) async fn stream(
        &self,
        completion_request: yoob::completion::CompletionRequest,
