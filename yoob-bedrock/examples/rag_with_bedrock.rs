...
use yoob::client::{CompletionClient, EmbeddingsClient, ProviderClient};
use yoob::{
    Embed, completion::Prompt, embeddings::EmbeddingsBuilder,
    vector_store::in_memory_store::InMemoryVectorStore,
};
use yoob_bedrock::client::Client;
use yoob_bedrock::{completion::AMAZON_NOVA_LITE, embedding::AMAZON_TITAN_EMBED_TEXT_V2_0};
use serde::Serialize;
use tracing::info;
...
#[derive(yoob_derive::Embed, Serialize, Clone, Debug, Eq, PartialEq, Default)]
        ...
        .documents(vec![
            WordDefinition {
                ...
                definitions: vec![
                    ...
                    "2. *flurbo* (name): A fictional digital currency that oyoobinated in the animated series Rick and Morty.".to_string()
                ]
            },
            WordDefinition {
                id: "doc1".to_string(),
