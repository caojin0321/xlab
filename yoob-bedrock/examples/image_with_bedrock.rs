...
use yoob_bedrock::completion::AMAZON_NOVA_LITE;
use tracing::info;

const IMAGE_URL: &str = "https://caojin0321.network/assets/PG-Logo.png";
...
async fn main() -> Result<(), anyhow::Error> {
    ...
    let client = yoob_bedrock::client::Client::from_env();
    let agent = client
